...
interface DiarySecondPageProps {}

const DiarySecondPage: FC<DiarySecondPageProps> = ({}) => {
  return (
    <div className="w-[148mm] h-[210mm] print:size-[A4] bg-exec text-white shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] flex flex-col relative py-20 pl-16">
      <PageHeader></PageHeader>
      <div className="w-full bg-[#023450] h-full p-10 pr-20">
        <div className="flex items-end justify-end">
          <div className="bg-white h-24 w-[500px] flex items-center justify-between px-8 ">
            <h1 className="text-exec text-xl w-2/3 font-semibold">
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex flex-col gap-4">
            <h1 className="text-2xl w-60">Welcome to ExEC product catalog.</h1>
            <p>Your Safety, Our Priority</p>
            <p className="w-48 text-sm font-light ">
...
export default DiarySecondPage;

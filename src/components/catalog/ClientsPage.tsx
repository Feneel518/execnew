    ...
    s7.082,3.171,7.082,7.082S44.298,288.955,40.387,288.955z"
        ...
        <div className="mt-10 flex items-center justify-between">
          <div className="flex flex-col gap-8">
            <h1 className="text-5xl w-60">Conclusin</h1>

            <p className="w-40 text-sm font-light ">
              At Explosion Proof Electrical Control, we stand as a beacon of
              safety and innovation in the realm of flameproof solutions. As we
              navigate the dynamic landscapes of various industries, our
              commitment to excellence, integrity, and the highest safety
              standards remains unwavering. We believe in forging lasting
              partnerships that extend beyond the products we deliver.
            </p>
          </div>
          <div className="w-36">
            <Image
